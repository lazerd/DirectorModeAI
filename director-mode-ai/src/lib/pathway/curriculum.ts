...
export const LEVELS: Level[] = [
  {
    ...
    stripes: [
      ...
      s('red', 4, 'Serve & Score', [
        t('3 of 5 underhand serves land in a service box',
          'Starting a point by themselves — the first step of independence. Not accuracy, not a service game.',
          'Player serves underhand from the 36-foot baseline, standing wherever they are comfortable. Coach points at the box to aim for, then steps out of the way. Five attempts, no rush.',
          '3 of 5 land in a service box. At Red Ball the WRONG box still counts — getting the ball over the net and in, unaided, is the whole skill here.'),
        t('Count the score out loud through a first-to-5 game — 1, 2, 3, 4, 5',
          'Scoring literacy at Red Ball age: counting points and knowing who is ahead. The 0-15-30-40 ladder waits until Orange.',
          `Coach and player play a quick first-to-5 game off coach feeds. After every single point the coach asks "what's the score?" and the player answers out loud.`,
          'Calls the running score correctly after at least 4 of the 5 points and says who won at the end. Counting on fingers is completely fine.'),
        t('Call your own ball in or out — and mean it',
          ...
          "Makes a clear, out-loud call both times. Whether the call is RIGHT does not matter at Red Ball — hesitating, looking at a grown-up, or refusing to call does. One coaching moment is allowed, then a retest ball."),
      ]),
      s('red', 5, 'Play', [
        t('Play 3 points start to finish, each starting with an underhand serve',
          ...
          'Player plays 3 points with the coach as the other player. The coach keeps every ball easy and rescues the rally when needed. If the serve misses twice, the coach drops a ball in and the point is played anyway — it still counts.',
          'All 3 points get started by the player and played to a finish. Winning is NOT required at Red Ball, and neither is a serve that lands in: two attempts, then the coach feeds. This is not a service game.'),
  ...
  },
  {
    ...
    stripes: [
      s('orange', 1, 'Footwork', [
        t('Split step on 8 of 10 feeds — unprompted',
          'The split step as an automatic habit, not a coached reminder.',
          'Coach feeds 10 balls at rally pace, alternating sides, and watches only the feet. No reminders once the drill starts.',
          "8 of 10 balls have a visible split step timed to the coach's contact. Reminded split steps do not count toward the eight."),
      ...
      s('orange', 4, 'Serve', [
        ...
        t('4 of 8 serves into the correct box from the orange baseline',
          ...
          '8 overhand serves from the 60-foot baseline, alternating deuce and ad the way a real match does. Coach stays quiet — the player works out which box is theirs.',
          '4 of 8 in the correct diagonal box. Underhand does not count at this level.'),
      ...
      s('orange', 5, 'Compete', [
        ...
        t('Run the between-point jobs yourself — balls, sides, and the score out loud',
          'The first taste of independence, plus real tennis scoring: 0, 15, 30, 40, game (moved up from Red, where it never belonged).',
          'Observed during the mini match above: does the player collect balls, go to the right side, and announce the score without being steered? Afterwards the coach asks them to recite the real scoring ladder.',
          'At most one reminder across the whole match, AND the 0-15-30-40-game ladder recited in order. Two or more reminders means a retest next month — this one comes fast with a month of practice.'),
      ]),
    ],
  },
  {
