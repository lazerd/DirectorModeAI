...
export const LEVELS: Level[] = [
  {
    ...
    stripes: [
      ...
      s('red', 5, 'Play', [
        t('Play 3 full points start to finish, serving, no reset',
          'Putting every skill together: serve, rally, score, finish the point.',
          'Player plays 3 points against a peer (coach may receive if numbers are odd). Player serves all 3, calls the score before each, and plays each point to a real finish.',
          'All 3 points are legitimate: legal serve, honest calls, score announced. Winning is NOT required — completing real points is.'),
        t('Win one tiebreak to 7 against another kid',
          'Competing — staying in a real scoreboard battle from start to finish.',
          'A standard first-to-7 tiebreak against a peer of similar level, alternating underhand serves, coach observes only.',
          'Win one tiebreak. Multiple attempts across the month are fine — this can run in class before Test Day and bank when won.'),
        t('Shake hands and say the score at the end',
          'Sportsmanship as a habit — every match ends at the net.',
          'Observed at the end of the tiebreak above: does the player come to the net, shake hands, and state the final score without being told?',
          'Does all three unprompted. Being reminded once means a retest at the next match.'),
      ]),
    ],
  },
  {
    ...
    stripes: [
      ...
      s('orange', 2, 'Groundstroke Shape', [
        t('8 of 10 forehands land past the service line, full finish over the shoulder',
          ...
          '8 of 10 land beyond the service line AND carry a full over-the-shoulder finish. A deep ball with a chopped finish is a miss.'),
        t('6 of 10 backhands the same',
          'The same depth-and-shape standard on the weaker wing.',
          'Identical to the forehand test: 10 feeds to the backhand, same target.',
          '6 of 10 deep with a full finish. Two-handed is expected at this level.'),
      ...
      s('orange', 4, 'Serve', [
        ...
        t('A second serve that goes in when the first one misses',
          ...
          '4 of 5 second serves land in. The point is a repeatable safe serve, not pace.'),
      ]),
      s('orange', 5, 'Compete', [
        t('Play a full match to 4 games, serving, keeping your own score',
          'A complete, self-run match — the promotion is earned by playing real tennis.',
          'First to 4 games against a peer, ordinary rules, players call their own lines and announce the score every point. Coach watches from outside the fence.',
          'The match completes with correct scorekeeping and honest calls. The result does not matter; running the match does.'),
        t('Win 2 of 3 points at the net after an approach shot',
          ...
          'Coach feeds a short ball; player approaches, then plays out the point against the coach, who hits catchable passes. Run 3 points.',
          'Win 2 of the 3 net points. Staying on the baseline after the short ball is an automatic miss for that point.'),
        t('Play the whole match without a coach running it',
          'Independence: warm-up, spin for serve, changeovers, all handled by the players.',
          'Observed during the 4-game match above. Coach may not answer procedural questions — the players resolve them.',
          'The match runs start to finish with zero coach intervention. One rescue means a retest at the next Test Day.'),
      ]),
    ],
  },
  {
