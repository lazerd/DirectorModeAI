...
function TrialBannerInner() {
  ...
  useEffect(() => {
    ...
    if (pathname === '/' || pathname.startsWith('/login') || pathname.startsWith('/register') || pathname.startsWith('/pricing') || pathname.startsWith('/join') || pathname === '/c' || pathname.startsWith('/c/') || pathname.startsWith('/q/') || pathname.startsWith('/checkin/') || pathname.startsWith('/demo/')) return;
    (async () => {
      try {
