...
const FEATURES = [
  ...
  },
  {
    ...
    iconBg: 'bg-[#D3FB52]/10',
    mockup: [
      { type: 'line', court: '1', line: 'Theo d. Dario', score: '8–2', done: true },
      { type: 'line', court: '2', line: 'Ada d. Simone', score: '8–4', done: true },
      { type: 'line', court: '3', line: 'Jonah vs Ellis', score: 'live', done: false },
      { type: 'line', court: '4', line: 'Ines/Otto d. Renn/Sasha', score: '8–6', done: true },
    ],
  ...
  },
  {
    ...
    title: 'Never short a fourth again',
    description: 'A member posts a game that needs players. Members at the right level get an email and join in one tap.',
    icon: Users,
    iconColor: 'text-emerald-400',
    iconBg: 'bg-emerald-400/10',
    mockup: [
      { type: 'event', title: 'Tue 9:00am Doubles', sport: '3.0–3.5', players: '4/4', status: 'Full' },
      { type: 'event', title: 'Thu 6:00pm Mixed', sport: '3.5–4.0', players: '3/4', status: 'Open' },
      { type: 'event', title: 'Sat 8:00am Singles', sport: '4.0', players: '2/2', status: 'Full' },
    ],
    stats: ['Matched by level', 'No login to join', 'One club only'],
  },
  {
    id: 'mixer',
    tag: 'MixerMode',
    ...
    description: 'Turn a roster into a full round robin in one click. Players pre-loaded, courts assigned.',
    icon: Shuffle,
