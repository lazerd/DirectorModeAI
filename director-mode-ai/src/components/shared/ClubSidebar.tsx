...
const PUBLIC_PREFIXES = [
  ...
  '/leagues/rsvp',
  '/leagues/join',
  // CourtConnect's emailed links ("I'm in", "stop these emails"). No login.
  '/play',
  '/enter',
  '/pathway/p',
  '/pathway/curriculum',
        ...
        if (mem && (mem as any).role === 'member') {
          ...
          setMemberNav([{
            ...
            items: [
              ...
              // to open the app. Always shown, court reservations or not.
              { name: 'CourtConnect', href: '/member/games', matches: ['/member/games'], icon: Handshake, color: '#34d399' },
