...
const S: Record<string, React.CSSProperties> = {
  ...
  courtBusy: { display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 12, padding: 12, borderRadius: 10, border: '1px solid #bbf7d0', background: '#f0fdf4' },
  ...
  courtBody: { flex: '1 1 170px', minWidth: 0 },
  courtButtons: { display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap', marginLeft: 'auto' },
