...
export default async function PublicEventLandingPage({
  ...
  const isTeamBattle = e.match_format === 'team-battle';
  const isMixedDoubles = e.match_format === 'mixed-doubles';
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        {(waitlistCount ?? 0) > 0 && (
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 text-sm text-amber-200">
            Waitlist: {waitlistCount}. Registering now will add you to the waitlist.
          </div>
        )}
