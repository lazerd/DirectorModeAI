...
import { Users, Home, CalendarPlus, UserCircle, Globe, Trophy, Database } from 'lucide-react';
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-white border-r border-gray-200">
        ...
        <div className="p-5 border-b border-gray-200">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-courtconnect flex items-center justify-center">
              <Users size={18} className="text-white" />
            </div>
            <div>
              <span className="font-display text-lg block leading-tight">CourtConnect</span>
              <span className="text-xs text-gray-500">Player Matching</span>
            </div>
          </Link>
        </div>
