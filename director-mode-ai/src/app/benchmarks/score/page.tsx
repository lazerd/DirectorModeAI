    ...
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-teal-200 bg-teal-50 p-5">
        ...
        <p className="text-sm text-slate-600 mt-1">
          Stay anonymous on ClubMode Recruiting. We'll quietly alert you when a club within your range posts an opening that beats {usd(r.currentComp)} — and only reveal you on a match.
        </p>
