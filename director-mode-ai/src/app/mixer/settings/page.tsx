...
/*
 * The "Payouts (Stripe)" card is gone. It ran Stripe Connect onboarding on a
 * platform Stripe account that is disabled, so a director could only create an
 * Express account nothing would ever pay into. Paid entry is now a payment link
 * pasted on each tournament; /api/stripe/connect/* answer 410.
 */
