  ...
  const tournamentFormats: TournamentCard[] = [
    {
      ...
      subChoices: [
        ...
        },
        {
          ...
          status: 'live',
          route: '/mixer/tournaments/new?format=fmlc-singles',
        },
        {
          id: 'ffic-singles',
          ...
          status: 'live',
          route: '/mixer/tournaments/new?format=ffic-singles',
        },
      ],
    },
    {
      ...
      subChoices: [
        ...
        },
        {
          ...
          description: 'Only first-round losers get a consolation bracket.',
          status: 'live',
          route: '/mixer/tournaments/new?format=fmlc-doubles',
        },
        {
          id: 'ffic-doubles',
          name: 'Full Feed-In Consolation',
          description: 'Every loser feeds into a consolation bracket — everyone plays multiple matches.',
          status: 'live',
          route: '/mixer/tournaments/new?format=ffic-doubles',
        },
      ],
    },
    {
      ...
      subChoices: [
        {
          ...
          status: 'live',
          route: '/mixer/tournaments/new?format=rr-singles',
        },
        {
          ...
          status: 'live',
          route: '/mixer/tournaments/new?format=rr-doubles',
        },
      ],
    },
    {
