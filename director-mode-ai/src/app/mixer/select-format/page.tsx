    ...
    <div className="p-6 lg:p-8 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            {formData.match_format && (
              <div className="p-4 bg-orange-50 rounded-xl border-2 border-orange-200">
                ...
                <Link href="/mixer/select-format" className="text-sm text-orange-600 hover:underline">
                  Change format →
                </Link>
              </div>
            )}
        ...
        <div className="flex gap-3">
          <Link href="/mixer/select-format" className="flex-1 py-2 text-center border border-gray-300 rounded-lg hover:bg-gray-50">
            Cancel
          </Link>
          <button
            type="submit"
